...
// import { mainnet } from '../../models/Chain';
...
const AccountDetail: React.FC<AccountDetailProps> = ({account}) => {
  ...
  //useEffect whenevern we load a new account the first thing it will do is call ethers to basically call ethers to get us the balance in that account 
  useEffect(() => {
    ...
    fetchData();
}, [account.address]) //every time this called the fetch data function is called again 
  ...
  function handleAmountChange(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    // when the transfer is called which is when the send eth button is clicked we calll the send token function 
    //if it is sucess the url for the transaction account will be shown and if doesent faild to send is shown 
